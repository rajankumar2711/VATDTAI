...
Feature: [MVP] [UI/UX] [RC] Reconciliation Smoke Suite
  ...
  @TC_613500 @ModuleAccess @GIDEI_Smoke
  Scenario: Verify authorized Global Insights And Data Enrichment For e-Invoicing user can access Reconciliation module and reach batch reconciliation workflow
  ...
  @TC_613503 @FileUpload @Reconcile @GIDEI_Sanity
  ...
  @TC_626740 @ResultSummary @GIDEI_Sanity
