...
Feature: [MVP] [UI/UX] [IM] e-Invoice Management Smoke Suite
  ...
  @InboundColumns @Inbound @VAT_DTAI_Sanity
  Scenario: Verify all columns are displayed under Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
    When I apply valid filter criteria in Invoice Management module
    Then all columns are displayed in Inbound Invoices (AP) grid

  @InboundFilter @ClearFilter @Inbound @VAT_DTAI_Sanity
  Scenario: Verify the Status column filter and Clear Filter functionality for Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
  ...
  @InboundResetView @Inbound @VAT_DTAI_Sanity
  Scenario: Verify the Reset View functionality for Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
    And I click on Show Filter option in Inbound Invoices (AP) grid
    Then User is able to filter the records with Ready status in Inbound Invoices (AP) grid
    And I click on Reset View button to reset all filters applied
  ...
  @InboundExport @Inbound @VAT_DTAI_Sanity
  Scenario: Verify the export functionality for Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
  ...
  @InboundInvoiceDetails @Inbound @VAT_DTAI_Smoke
  Scenario: Verify the application display the invoice details in Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
  ...
  @InboundInvoiceExtractdetails @Inbound @VAT_DTAI_Sanity
  Scenario: Verify the application display the Inbound Invoice Extract in Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
  ...
  @InboundInvoiceErrorDetails @Inbound @VAT_DTAI_Sanity
  Scenario: Verify the application display the Inbound Invoice Error details in Inbound Invoices (AP) grid in Invoice Management module for Admin role under VAT DTAI app in GTP IT
    When I navigate to Invoice Management module
