...
Feature: [MVP] [UI/UX] [DL] Data Lake Smoke Suite
  ...
  @TC_616426 @ModuleAccess @Admin @VAT_DTAI_Smoke
  Scenario: Verify authorized VAT DTAI user can navigate to Data Lake IP tab and all mandatory page sections render successfully
